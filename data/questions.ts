...
export const articleData = {
  ...
  questions: {
    ...
    27: {
      ...
      locationParagraph: "A",
      locationSentence: "Some of the most important decisions of our lives occur while we're feeling stressed and anxious... we are all sometimes required to weigh up information under stressful conditions.",
      translation: "我们生活中一些最重要的决定往往是在感到压力和焦虑时做出的...我们有时都需要在压力条件下权衡信息。",
      errorAnalysis: "文章开头提到每个人都面临的挑战：在压力下做重要决定。"
    },
    28: {
      ...
      locationParagraph: "B",
      locationSentence: "These ups and downs presented the perfect setting for an experiment on how people's ability to use information changes when they feel under pressure.",
      translation: "这些起伏为研究人们在压力下使用信息的能力如何变化提供了完美的实验环境。",
      errorAnalysis: "消防员工作压力有起伏变化，正是理想的实验对象。"
    },
    29: {
      ...
      locationParagraph: "D",
      locationSentence: "This is how we arrived at these results. We asked the firefighters to estimate...",
      translation: "我们就是这样得出这些结果的。我们要求消防员们估计...",
      errorAnalysis: "第四段描述了实验方法（让消防员预估概率，然后告诉好消息或坏消息）。"
    },
    30: {
      ...
      errorAnalysis: "大脑机制增强了对外部威胁信号的敏感度。"
    },
    // 句子配对 31-35
    31: {
    ...
    32: {
      ...
      translation: "在这种情况下，他们对坏消息变得高度警惕，即使这些消息与他们的工作毫无关系，并据此调整了他们的信念。",
      errorAnalysis: "原文说压力下消防员变得'对坏消息高度警惕'，意思是他们认为坏事更可能发生。",
      synonymPairs: [
        { from: "hyper-vigilant to bad news", to: "thought it more likely to experience something bad" }
      ]
    },
    33: {
      ...
      errorAnalysis: "压力不会改变他们对好消息的反应，无论是否处于压力下，反应都一样。"
    },
    34: {
      ...
      locationParagraph: "F",
      locationSentence: "Back in our lab, we observed the same pattern in students who were told they had to give a surprise public speech... their cortisol levels spiked, their heart rates went up",
      translation: "回到实验室，我们观察到，在那些被告知必须进行一场出人意料的公开演讲的学生身上...他们的皮质醇水平飙升，心率加快。",
      errorAnalysis: "研究者让学生准备公开演讲，制造压力场景，导致生理指标变化。"
    },
    35: {
      ...
      errorAnalysis: "两个实验都表明：压力下人们对负面信息处理更好。"
    },
    // 判断题 36-40
    36: {
      ...
      errorAnalysis: "社交媒体内容反映接收到的帖子性质。"
    },
    37: {
      ...
      errorAnalysis: "文章提到手机与压力有关，但未与其他电子设备比较。"
    },
    38: {
      ...
      options: { A: "YES", B: "NO", C: "NOT GIVEN" },
      locationParagraph: "K",
      locationSentence: "After a stressful public event... individuals become very aware of.",
      translation: "在令人紧张的公共事件后...人们对此非常关注。",
      errorAnalysis: "文章说人们会「非常关注」这些信息，而不是更难以吸收。"
    },
    39: {
      ...
      errorAnalysis: "原文明确举例：取消旅行、抛售股票，这些都是不必要的预防措施。",
      synonymPairs: [
        { from: "trips are cancelled", to: "unnecessary precautions" },
        { from: "stocks are sold", to: "unnecessary financial precautions" }
      ]
    },
    40: {
      ...
      errorAnalysis: "积极情绪也会传染，可以用来激励人们寻找解决方案。"
    }
  }
};
